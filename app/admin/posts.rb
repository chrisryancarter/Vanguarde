ActiveAdmin.register Post do
  ...
  #      :label => false,
  #      :as => :file
  #      #, :hint => f.template.image_tag(f.object.image.url)
  #    #
  #    f.hidden_field :image_cache

  #    f.input :body,
  #      :label => false,
  #      :input_html => { :placeholder => "Body..", :class => "wysiwyg" }

  #    f.input :snippet,
  #      :label => false,
  #      :input_html => { :placeholder => "Snippet", :rows => 2, :class => "wysiwyg" }
